...
func ExampleToDoItemsAsJson() {
	ToDoItemsAsJson(ToDoItem{1, "Washing up"}, ToDoItem{2, "Ironing"}, ToDoItem{3, "Food shop"}, ToDoItem{4, "Wash car"}, ToDoItem{5, "Buy fish and chips"}, ToDoItem{6, "Renew car insurance"}, ToDoItem{7, "Complete Go tasks"}, ToDoItem{8, "return parcel"}, ToDoItem{9, "Organise cutlery drawer"}, ToDoItem{10, "Dust the mantle"})
